...
public class TurnUIPresenter : MonoBehaviour
{
    ...
    {//옵저버 패턴 버튼이 눌릴때마다 이벤트 핸들러 행동이 바뀌게
        ...
        playUI.Start.onClick.AddListener(() => { Local.TurnSystem.TurnStart(true); Local.EventHandler.Invoke<EnemyTurnSelect>(EnumType.EnemyTurnSelect, EnemyTurnSelect.EnemyTurnSelect); });
